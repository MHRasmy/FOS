...
//		panic("page_fault_handler().PLACEMENT is not implemented yet...!!");
		...
		/* Creating the Working Set Element */
		struct WorkingSetElement* val = (struct WorkingSetElement*) env_page_ws_list_create_element(curenv,fault_va);
		LIST_INSERT_TAIL(&(curenv->page_WS_list),val);
